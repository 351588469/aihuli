 ...
 * @version
 */
@Service("gmhealthService")
public class GMHealthService implements GMHealthManager{
	...
	public void save(PageData pd)throws Exception{
		dao.save("GMHealthMapper.save", pd);
	}
	...
	public void delete(PageData pd)throws Exception{
		dao.delete("GMHealthMapper.delete", pd);
	}
	...
	public void edit(PageData pd)throws Exception{
		dao.update("GMHealthMapper.edit", pd);
	}
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("GMHealthMapper.datalistPage", page);
	}
	...
	public void deleteAll(String[] ArrayDATA_IDS)throws Exception{
		dao.delete("GMHealthMapper.deleteAll", ArrayDATA_IDS);
	}
