...
public class Logger2 {
	 ...
	 * 构造方法，初始化Log4j的日志对象
	 */
	private Logger2(org.apache.log4j.Logger log4jLogger) {
		logger = log4jLogger;
	}
	...
	public static Logger2 getLogger(Class classObject) {
		return new Logger2(org.apache.log4j.Logger.getLogger(classObject));
	}
	...
	public static Logger2 getLogger(String loggerName) {
		return new Logger2(org.apache.log4j.Logger.getLogger(loggerName));
	}
